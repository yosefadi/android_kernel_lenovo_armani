...
/*End: WNC Edware 2010/01/26 added to show ctp information*/

// [ -- WNC-NJ:Peitao change touch panel max X and Y  @ 20110820
#define SCREEN_MAX_X    480
#define SCREEN_MAX_Y    854
// -- WNC-NJ:Peitao change touch panel max X and Y  @ 20110820 ]
#define PRESS_MAX       200

//#define FT5X0X_NAME	"qwerty"//"synaptics_i2c_rmi"//"synaptics-rmi-ts"// 

//[--WNC Ophas 2011-08-18, for gesture key of touch screen B area
#define FT5X0X_GESTURE_NAME	"ft5x0x_ts_gesture"
//WNC Ophas 2011-08-18, for gesture key of touch screen B area--]
...
#define FT5x06_WAKEUP      	26 
#define FT5x06_IRQ               48

#define KEY_LTR                249     //gesture left to right
#define KEY_UTD                250     //gesture up to down
#define KEY_SC         251     //gesture single click
