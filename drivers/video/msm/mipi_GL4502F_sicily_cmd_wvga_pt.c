...
static int __init mipi_cmd_GL4502F_alaska_wvga_pt_init(void)
{
	int ret;

	if (msm_fb_detect_client("mipi_cmd_GL4502F_wvga"))
		return 0;
...
//	pinfo.is_3d_panel = FB_TYPE_3D_PANEL;
	...
	ret = mipi_GL4502F_alaska_device_register(&pinfo, MIPI_DSI_PRIM,
...
module_init(mipi_cmd_GL4502F_alaska_wvga_pt_init);
