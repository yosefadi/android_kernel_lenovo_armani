...
static char vcl_power_set1[2]={ //steve add for cmd mode
     0xB8,0x24};
static char vcl_power_set2[2]={ //steve add for cmd mode
  0xB2,0x00};
...
/*static char regw1_set[5]={
	0xF0,0xAA,0x55,0x25,0x01 
    };*/
/*static char regw2_set[]={
	0x3a,0x77 
    };
*/
...
/*static char cmd_set8[1]={
    0x2c
    }; */ 
/*static char vscan_set[3]={
    0xB1,0xF8,0x00
    };*/
/*    
static char lane_set[2]={
    0xae,0x03
    };
    */  
...
static struct dsi_cmd_desc nt35510_alaska_cmd_on_cmds_video_mode[] = {
	...
	{DTYPE_GEN_WRITE1, 1, 0, 0, 0, sizeof(cmd_set2), cmd_set2},
