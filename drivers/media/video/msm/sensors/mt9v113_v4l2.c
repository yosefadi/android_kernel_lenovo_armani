...
{0x0990, 0xFFBA}, 	// MCU_DATA_0
{0x098C, 0x2328}, 	// MCU_ADDRESS [AWB_CCM_RL_6]
{0x0990, 0x005D}, 	// MCU_DATA_0
{0x098C, 0x2314}, 	// MCU_ADDRESS [AWB_CCM_L_7]
{0x0990, 0xFF0A}, 	// MCU_DATA_0
{0x098C, 0x232A}, 	// MCU_ADDRESS [AWB_CCM_RL_7]
{0x0990, 0x00C0}, 	// MCU_DATA_0
{0x098C, 0x2316}, 	// MCU_ADDRESS [AWB_CCM_L_8]
{0x0990, 0x0274}, 	// MCU_DATA_0
{0x098C, 0x232C}, 	// MCU_ADDRESS [AWB_CCM_RL_8]
{0x0990, 0xFEDC}, 	// MCU_DATA_0

	{0x098C, 0x2318},	// MCU_ADDRESS [AWB
	{0x0990, 0x0016},	// MCU_DATA_0
	{0x098C, 0x231A},	// MCU_ADDRESS [AWB
	{0x0990, 0x003F},	// MCU_DATA_0
	{0x098C, 0x232E},	// MCU_ADDRESS [AWB
	{0x0990, 0x000B},	// MCU_DATA_0
	{0x098C, 0x2330},	// MCU_ADDRESS [AWB
	{0x0990, 0xFFF7},	// MCU_DATA_0
	{0x098C, 0xA34A},	// MCU_ADDRESS [AWB
	{0x0990, 0x0059},	// MCU_DATA_0
	{0x098C, 0xA34B},	// MCU_ADDRESS [AWB
	{0x0990, 0x00FB},	// MCU_DATA_0
	{0x098C, 0xA34C},	// MCU_ADDRESS [AWB
	{0x0990, 0x0059},	// MCU_DATA_0
	{0x098C, 0xA34D},	// MCU_ADDRESS [AWB
	{0x0990, 0x0086},	// MCU_DATA_0
	{0x098C, 0xA302},	// MCU_ADDRESS [AWB
	{0x0990, 0x0011},	// MCU_DATA_0
	{0x098C, 0xA303},	// MCU_ADDRESS [AWB
	{0x0990, 0x00DD},	// MCU_DATA_0
	{0x098C, 0xA351},	// MCU_ADDRESS [AWB
	{0x0990, 0x0000},	// MCU_DATA_0
	{0x098C, 0xA352},	// MCU_ADDRESS [AWB
	{0x0990, 0x007F},	// MCU_DATA_0
	{0x098C, 0xA355},	// MCU_ADDRESS [AWB
	{0x0990, 0x000A},	// MCU_DATA_0
	{0x098C, 0xA35D},	// MCU_ADDRESS [AWB
	{0x0990, 0x007E},	// MCU_DATA_0
	{0x098C, 0xA35E},	// MCU_ADDRESS [AWB
	{0x0990, 0x0082},	// MCU_DATA_0
	{0x098C, 0xA35F},	// MCU_ADDRESS [AWB
	{0x0990, 0x007F},	// MCU_DATA_0
	{0x098C, 0xA360},	// MCU_ADDRESS [AWB
	{0x0990, 0x0081},	// MCU_DATA_0
	{0x098C, 0x2361},	// MCU_ADDRESS [RES
	{0x0990, 0x0140},	// MCU_DATA_0
	{0x098C, 0xA353},	// MCU_ADDRESS [AWB
	{0x0990, 0x0070},	// MCU_DATA_0
	{0x098C, 0xA34E},	// MCU_ADDRESS [AWB
	{0x0990, 0x00BC},	// MCU_DATA_0
	{0x098C, 0xA34F},	// MCU_ADDRESS [AWB
	{0x0990, 0x0080},	// MCU_DATA_0
	{0x098C, 0xA350},	// MCU_ADDRESS [AWB
	{0x0990, 0x006A},	// MCU_DATA_0
	{0x098C, 0xA365},	// MCU_ADDRESS
	{0x0990, 0x0028},	// MCU_DATA_0
	{0x098C, 0xA363},	// MCU_ADDRESS [RES
	{0x0990, 0x00D8},	// MCU_DATA_0
	{0x098C, 0xA364},	// MCU_ADDRESS [RES
	{0x0990, 0x00E4},	// MCU_DATA_0
	{0x098C, 0xA366},	// MCU_ADDRESS [AWB
	{0x0990, 0x00AE},	// MCU_DATA_0
	{0x098C, 0xA367},	// MCU_ADDRESS [AWB
	{0x0990, 0x009D},	// MCU_DATA_0
	{0x098C, 0xA368},	// MCU_ADDRESS [AWB
	{0x0990, 0x0080},	// MCU_DATA_0
	{0x098C, 0xA369},	// MCU_ADDRESS [AWB
	{0x0990, 0x0084},	// MCU_DATA_0
	{0x098C, 0xA36A},	// MCU_ADDRESS [AWB
	//{0x0990, 0x0082},	// MCU_DATA_0
{0x0990, 0x0084},	// MCU_DATA_0
	{0x098C, 0xA36B},	// MCU_ADDRESS [AWB
	{0x0990, 0x007C},	// MCU_DATA_0
	{0x3240, 0xEB14},	// RESERVED_SOC1_32
	{0x3244, 0x0304},	// RESERVED_SOC1_32
	{0x098C, 0x275F},	// MCU_ADDRESS [RES
	{0x0990, 0x059F},	// MCU_DATA_0
	{0x098C, 0x2761},	// MCU_ADDRESS [RES
	{0x0990, 0x00AA},	// MCU_DATA_0
	{0x098C, 0xA117},	// MCU_ADDRESS [SEQ
	{0x0990, 0x0001},	// MCU_DATA_0
	{0x098C, 0xA119},	// MCU_ADDRESS [SEQ
	{0x0990, 0x0000},	// MCU_DATA_0
	{0x098C, 0xA11A},	// MCU_ADDRESS [SEQ
	{0x0990, 0x0000},	// MCU_DATA_0
	{0x098C, 0xA11D},	// MCU_ADDRESS [SEQ
	{0x0990, 0x0002},	// MCU_DATA_0
	{0x098C, 0xA11E},	// MCU_ADDRESS [SEQ
	{0x0990, 0x0001},	// MCU_DATA_0
	{0x098C, 0xA11F},	// MCU_ADDRESS [SEQ
	{0x0990, 0x0001},	// MCU_DATA_0
	{0x098C, 0xA120},	// MCU_ADDRESS [SEQ
	{0x0990, 0x0001},	// MCU_DATA_0
	{0x098C, 0xA129},	// MCU_ADDRESS [SEQ
	{0x0990, 0x0002},	// MCU_DATA_0
	{0x098C, 0xA111},	// MCU_ADDRESS
	{0x0990, 0x000A},	// MCU_DATA_0
	{0x098C, 0xA20C},	// MCU_ADDRESS [AE_
	//{0x0990, 0x000B},	// MCU_DATA_0
{0x0990, 0x000A},	// MCU_DATA_0
	{0x098C, 0xA215},	// MCU_ADDRESS [AE_
	{0x0990, 0x0008},	// MCU_DATA_0
	{0x098C, 0xA216},	// MCU_ADDRESS [AE_
	{0x0990, 0x0040},	// MCU_DATA_0
	{0x098C, 0xA228},	// MCU_ADDRESS [RES
	{0x0990, 0x0080},	// MCU_DATA_0
	{0x098C, 0xA20D},	// MCU_ADDRESS [AE_
	{0x0990, 0x0030},	// MCU_DATA_0
	{0x098C, 0xA20E},	// MCU_ADDRESS [AE_
	{0x0990, 0x0080},	// MCU_DATA_0
	{0x098C, 0x2212},	// MCU_ADDRESS [RES
	{0x0990, 0x00FE},	// MCU_DATA_0
	{0x098C, 0xA244},	// MCU_ADDRESS [RES
	{0x0990, 0x0008},	// MCU_DATA_0
	{0x098C, 0xA24F},	// MCU_ADDRESS [AE_
	//{0x0990, 0x003D},	// MCU_DATA_0
{0x0990, 0x003F},// MCU_DATA_0
	{0x098C, 0xA207},	// MCU_ADDRESS [AE_
	{0x0990, 0x0006},	// MCU_DATA_0
	{0x098C, 0xA202},	// MCU_ADDRESS [AE_
	{0x0990, 0x0033},	// MCU_DATA_0
	{0x098C, 0xA203},	// MCU_ADDRESS [AE_
	{0x0990, 0x00C9},	// MCU_DATA_0
	{0x098C, 0xA208},	// MCU_ADDRESS [RES
	{0x0990, 0x0003},	// MCU_DATA_0
	{0x098C, 0xA209},	// MCU_ADDRESS
	{0x0990, 0x0002},	// MCU_DATA_0
	{0x098C, 0xA20A},	// MCU_ADDRESS
	{0x0990, 0x0001},	// MCU_DATA_0
	{0x098C, 0xAB1F},	// MCU_ADDRESS [HG_
	{0x0990, 0x00C7},	// MCU_DATA_0
	{0x098C, 0x274F},	// MCU_ADDRESS [RES
	{0x0990, 0x0004},	// MCU_DATA_0
	{0x098C, 0x2741},	// MCU_ADDRESS [RES
	{0x0990, 0x0004},	// MCU_DATA_0
	{0x098C, 0xAB20},	// MCU_ADDRESS [HG_
	//{0x0990, 0x0029},	// MCU_DATA_0
{0x0990, 0x002B},	// MCU_DATA_0
	{0x098C, 0xAB21},	// MCU_ADDRESS [HG_
	{0x0990, 0x0010},	// MCU_DATA_0
	{0x098C, 0xAB22},	// MCU_ADDRESS [HG_
	{0x0990, 0x0003},	// MCU_DATA_0
	{0x098C, 0xAB23},	// MCU_ADDRESS [HG_
	{0x0990, 0x0005},	// MCU_DATA_0
	{0x098C, 0xAB24},	// MCU_ADDRESS [HG_
	{0x0990, 0x000D},	// MCU_DATA_0
	{0x098C, 0xAB25},	// MCU_ADDRESS [HG_
	{0x0990, 0x0024},	// MCU_DATA_0
	{0x098C, 0xAB26},	// MCU_ADDRESS [HG_
	{0x0990, 0x0003},	// MCU_DATA_0
	{0x098C, 0xAB27},	// MCU_ADDRESS [HG_
	{0x0990, 0x001A},	// MCU_DATA_0
	{0x098C, 0x2B28},	// MCU_ADDRESS [HG_
	{0x0990, 0x08A0},	// MCU_DATA_0
	{0x098C, 0x2B2A},	// MCU_ADDRESS [HG_
	{0x0990, 0x2400},	// MCU_DATA_0
	{0x098C, 0xAB2C},	// MCU_ADDRESS [HG_
	{0x0990, 0x000A},	// MCU_DATA_0
	{0x098C, 0xAB2D},	// MCU_ADDRESS [HG_
	{0x0990, 0x000A},	// MCU_DATA_0
	{0x098C, 0xAB2E},	// MCU_ADDRESS [HG_
	{0x0990, 0x000A},	// MCU_DATA_0
	{0x098C, 0xAB2F},	// MCU_ADDRESS [HG_
	{0x0990, 0x0006},	// MCU_DATA_0
	{0x098C, 0xAB30},	// MCU_ADDRESS [HG_
	{0x0990, 0x0020},	// MCU_DATA_0
	{0x098C, 0xAB31},	// MCU_ADDRESS [HG_
	{0x0990, 0x0020},	// MCU_DATA_0
	{0x098C, 0xAB32},	// MCU_ADDRESS [HG_
	{0x0990, 0x0020},	// MCU_DATA_0
	{0x098C, 0xAB33},	// MCU_ADDRESS [HG_
	{0x0990, 0x001E},	// MCU_DATA_0
	{0x098C, 0xAB34},	// MCU_ADDRESS [HG_
	{0x0990, 0x0010},	// MCU_DATA_0
	{0x098C, 0xAB35},	// MCU_ADDRESS [HG_
	{0x0990, 0x0070},	// MCU_DATA_0
	{0x098C, 0xAB36},	// MCU_ADDRESS [RES
	{0x0990, 0x0020},	// MCU_DATA_0
	{0x098C, 0xAB04},	// MCU_ADDRESS [HG_
	{0x0990, 0x0010},	// MCU_DATA_0
	{0x098C, 0xAB06},	// MCU_ADDRESS [HG_
	{0x0990, 0x000A},	// MCU_DATA_0
	{0x326C, 0x1605},	// APERTURE_PARAMET
	{0x098C, 0xAB37},	// MCU_ADDRESS [HG_
	{0x0990, 0x0003},	// MCU_DATA_0
	{0x098C, 0x2B38},	// MCU_ADDRESS [HG_
	{0x0990, 0x17A0},	// MCU_DATA_0
	{0x098C, 0x2B3A},	// MCU_ADDRESS [HG_
	{0x0990, 0x1F00},	// MCU_DATA_0
	{0x098C, 0xAB3C},	// MCU_ADDRESS [HG_
	{0x0990, 0x0000},	// MCU_DATA_0
	{0x098C, 0xAB3D},	// MCU_ADDRESS [HG_
	{0x0990, 0x0010},	// MCU_DATA_0
	{0x098C, 0xAB3E},	// MCU_ADDRESS [HG_
	{0x0990, 0x001F},	// MCU_DATA_0
	{0x098C, 0xAB3F},	// MCU_ADDRESS [HG_
	{0x0990, 0x0038},	// MCU_DATA_0
	{0x098C, 0xAB40},	// MCU_ADDRESS [HG_
	{0x0990, 0x005D},	// MCU_DATA_0
	{0x098C, 0xAB41},	// MCU_ADDRESS [HG_
	{0x0990, 0x007D},	// MCU_DATA_0
	{0x098C, 0xAB42},	// MCU_ADDRESS [HG_
	{0x0990, 0x0097},	// MCU_DATA_0
	{0x098C, 0xAB43},	// MCU_ADDRESS [HG_
	{0x0990, 0x00AB},	// MCU_DATA_0
	{0x098C, 0xAB44},	// MCU_ADDRESS [HG_
	{0x0990, 0x00BA},	// MCU_DATA_0
	{0x098C, 0xAB45},	// MCU_ADDRESS [HG_
	{0x0990, 0x00C6},	// MCU_DATA_0
	{0x098C, 0xAB46},	// MCU_ADDRESS [HG_
	{0x0990, 0x00D0},	// MCU_DATA_0
	{0x098C, 0xAB47},	// MCU_ADDRESS [HG_
	{0x0990, 0x00D9},	// MCU_DATA_0
	{0x098C, 0xAB48},	// MCU_ADDRESS [HG_
	{0x0990, 0x00E0},	// MCU_DATA_0
	{0x098C, 0xAB49},	// MCU_ADDRESS [HG_
	{0x0990, 0x00E7},	// MCU_DATA_0
	{0x098C, 0xAB4A},	// MCU_ADDRESS [HG_
	{0x0990, 0x00ED},	// MCU_DATA_0
	{0x098C, 0xAB4B},	// MCU_ADDRESS [HG_
	{0x0990, 0x00F2},	// MCU_DATA_0
	{0x098C, 0xAB4C},	// MCU_ADDRESS [HG_
	{0x0990, 0x00F7},	// MCU_DATA_0
	{0x098C, 0xAB4D},	// MCU_ADDRESS [HG_
	{0x0990, 0x00FB},	// MCU_DATA_0
	{0x098C, 0xAB4E},	// MCU_ADDRESS [HG_
	{0x0990, 0x00FF},	// MCU_DATA_0
	{0x098C, 0xAB4F},	// MCU_ADDRESS [HG_
	{0x0990, 0x0012},	// MCU_DATA_0
	{0x098C, 0xAB50},	// MCU_ADDRESS [HG_
	{0x0990, 0x0020},	// MCU_DATA_0
	{0x098C, 0xAB51},	// MCU_ADDRESS [HG_
	{0x0990, 0x0030},	// MCU_DATA_0
	{0x098C, 0xAB52},	// MCU_ADDRESS [HG_
	{0x0990, 0x0040},	// MCU_DATA_0
	{0x098C, 0xAB53},	// MCU_ADDRESS [HG_
	{0x0990, 0x0060},	// MCU_DATA_0
	{0x098C, 0xAB54},	// MCU_ADDRESS [HG_
	{0x0990, 0x0080},	// MCU_DATA_0
	{0x098C, 0xAB55},	// MCU_ADDRESS [HG_
	{0x0990, 0x00A1},	// MCU_DATA_0
	{0x098C, 0xAB56},	// MCU_ADDRESS [HG_
	{0x0990, 0x00B0},	// MCU_DATA_0
	{0x098C, 0xAB57},	// MCU_ADDRESS [HG_
	{0x0990, 0x00BC},	// MCU_DATA_0
	{0x098C, 0xAB58},	// MCU_ADDRESS [HG_
	{0x0990, 0x00C7},	// MCU_DATA_0
	{0x098C, 0xAB59},	// MCU_ADDRESS [HG_
	{0x0990, 0x00D0},	// MCU_DATA_0
	{0x098C, 0xAB5A},	// MCU_ADDRESS [HG_
	{0x0990, 0x00D8},	// MCU_DATA_0
	{0x098C, 0xAB5B},	// MCU_ADDRESS [HG_
	{0x0990, 0x00DF},	// MCU_DATA_0
	{0x098C, 0xAB5C},	// MCU_ADDRESS [HG_
	{0x0990, 0x00E6},	// MCU_DATA_0
	{0x098C, 0xAB5D},	// MCU_ADDRESS [HG_
	{0x0990, 0x00EC},	// MCU_DATA_0
	{0x098C, 0xAB5E},	// MCU_ADDRESS [HG_
	{0x0990, 0x00F1},	// MCU_DATA_0
	{0x098C, 0xAB5F},	// MCU_ADDRESS [HG_
	{0x0990, 0x00F6},	// MCU_DATA_0
	{0x098C, 0xAB60},	// MCU_ADDRESS [HG_
	{0x0990, 0x00FB},	// MCU_DATA_0
	{0x098C, 0xAB61},	// MCU_ADDRESS [HG_
	{0x0990, 0x00FF},	// MCU_DATA_0
	{0x322A, 0x0004},	// RESERVED_SOC1_32
	{0x098C, 0xAB1F},	// MCU_ADDRESS [HG_
	{0x0990, 0x00C7},	// MCU_DATA_0
...
static struct msm_camera_i2c_reg_conf mt9v113_special_effect[][8] = {
...
int mt9v113_exposure_msm_sensor_s_ctrl_by_enum(struct msm_sensor_ctrl_t *s_ctrl,
		struct msm_sensor_v4l2_ctrl_info_t *ctrl_info, int value)
{
	int rc = 0;
	CDBG("--CAMERA-- %s IN, value:%d\n", __func__, value);
...
int mt9v113_iso_msm_sensor_s_ctrl_by_enum(struct msm_sensor_ctrl_t *s_ctrl,
		struct msm_sensor_v4l2_ctrl_info_t *ctrl_info, int value)
{
	int rc = 0;
	CDBG("--CAMERA-- %s IN, value:%d\n", __func__, value);
...
int mt9v113_wb_msm_sensor_s_ctrl_by_enum(struct msm_sensor_ctrl_t *s_ctrl,
		struct msm_sensor_v4l2_ctrl_info_t *ctrl_info, int value)
{
	int rc = 0;
...
struct msm_sensor_v4l2_ctrl_info_t mt9v113_v4l2_ctrl_info[] = {
	...
	},
	{
		...
		.s_v4l2_ctrl = mt9v113_exposure_msm_sensor_s_ctrl_by_enum,
	},
	{
		...
		.s_v4l2_ctrl = mt9v113_iso_msm_sensor_s_ctrl_by_enum,
	},
	{
	...
	},
	{
		...
		.s_v4l2_ctrl = mt9v113_wb_msm_sensor_s_ctrl_by_enum,
	},
...
ssize_t proc_sensor_read (struct file *file, const char __user *buf, size_t nbytes, loff_t *ppos)
{
    char string[nbytes];
    int rc = 0;
    ...
    client.client = mt9v113_client;
    client.addr_type = MSM_CAMERA_I2C_WORD_ADDR;

    sscanf(buf, "%s", string);

    if (!strcmp((const char *)string, (const char *)"read"))
    {
	msm_camera_i2c_write(&client,0x098c, 0x2703,MSM_CAMERA_I2C_WORD_ADDR);
	// read flag
	rc = msm_camera_i2c_read(&client, 0x0990,&rdata,MSM_CAMERA_I2C_WORD_ADDR);

        if (rc < 0 )
        {
               pr_err("proc_sensor_read current setting error\n");
               rc = -ENOTSUPP;
        }
	else
	{
...
EXPORT_SYMBOL(proc_sensor_read);
