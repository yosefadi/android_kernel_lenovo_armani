...
enum {
	...
	/* yangjq, 20121127, Add vreg and tlmm nodes, START */
	PCOM_OEM_TEST_CMD_1,
	PCOM_OEM_TEST_CMD_2,
	PCOM_OEM_GPIO_TLMM_GET_OWNER,
	PCOM_OEM_GPIO_TLMM_GET_CFG,
	PCOM_OEM_GPIO_TLMM_SLEEP_TABLE_GET_CFG,
	PCOM_OEM_GPIO_TLMM_SLEEP_TABLE_SET_CFG,
	PCOM_OEM_GPIO_TLMM_LAST_SLEEP_GET_CFG,
  	PCOM_OEM_VREG_CTRL,
	PCOM_OEM_PM_GET_LOG,
	/* yangjq, 20121127, Add vreg and tlmm nodes, END */
	/* yangjq, 20121128, Add sysfs debug, START */
	PCOM_OEM_DEBUG_MEM_GET,
	PCOM_OEM_DEBUG_MEM_SET,
	PCOM_OEM_DEBUG_MEM_GO,
	/* yangjq, 20121128, Add sysfs debug, END */
	//PCOM_OEM_LAST = PCOM_OEM_TEST_CMD,
	PCOM_OEM_LAST = PCOM_OEM_DEBUG_MEM_GO,
};
