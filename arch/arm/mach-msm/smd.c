...
static irqreturn_t smd_modem_irq_handler(int irq, void *data)
{
	...
	interrupt_stats[SMD_MODEM].last_stamp = jiffies;
...
static irqreturn_t smd_dsp_irq_handler(int irq, void *data)
{
	...
	interrupt_stats[SMD_Q6].last_stamp = jiffies;
...
static irqreturn_t smd_dsps_irq_handler(int irq, void *data)
{
	...
	interrupt_stats[SMD_DSPS].last_stamp = jiffies;
...
static irqreturn_t smd_wcnss_irq_handler(int irq, void *data)
{
	...
	interrupt_stats[SMD_WCNSS].last_stamp = jiffies;
...
static irqreturn_t smd_rpm_irq_handler(int irq, void *data)
{
	...
	interrupt_stats[SMD_RPM].last_stamp = jiffies;
			...
			)
{
	...
	printk("smd: %s: register irq: %s id: %d\n", __func__,
