...
static int usb_chg_dis_func(const char *s,struct kernel_param *kp)
{
	printk("disable usb charger function\n");
	if(!strncmp(s,"1",1))
	{
...
module_param_call(usb_chg_dis,usb_chg_dis_func,NULL,NULL,0644);
