...
static struct clk_lookup msm_cmn_clk_7625a_7627a[] __initdata = {
	...
	CLK_LOOKUP("csi_clk",		csi0_clk.c,	"msm_camera_sp0a28.0"),
	CLK_LOOKUP("csi_pclk",		csi0_p_clk.c,	"msm_camera_sp0a28.0"),
	CLK_LOOKUP("csi_vfe_clk",	csi0_vfe_clk.c,	"msm_camera_sp0a28.0"),
