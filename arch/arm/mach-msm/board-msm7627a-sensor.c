...
#if defined(CONFIG_PSENSOR_RPR400)
#define RPR400_GPIO_IRQ 17
static struct i2c_board_info rpr400_i2c_info = {
    I2C_BOARD_INFO("als_ps", 0x39),
    .irq = MSM_GPIO_TO_INT(RPR400_GPIO_IRQ),
};
static struct msm_gpio rpr400_cfg_data[] = {
        {GPIO_CFG(RPR400_GPIO_IRQ, 0, GPIO_CFG_INPUT, GPIO_CFG_PULL_UP, GPIO_CFG_6MA),"rpr400_irq"},
};
...
static struct i2c_board_info yas_accelerometer_i2c_info[] __initdata = {
    {
...
{
#ifdef CONFIG_AVAGO_APDS990X
	if(machine_is_msm8625q_skud() ||  machine_is_msm7627a_evb() || machine_is_msm8625_evb() || machine_is_msm8625_qrd5() || machine_is_msm7x27a_qrd5a()) 
    {
	...
	if(machine_is_msm8625q_skud())
    {
        pr_info("i2c_register_board_info accelerometer\n");
        i2c_register_board_info(MSM_GSBI1_QUP_I2C_BUS_ID,
                yas_accelerometer_i2c_info,
                ARRAY_SIZE(yas_accelerometer_i2c_info));
	}
#endif
}
